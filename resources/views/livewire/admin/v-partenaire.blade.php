<div x-data="{
    ...
    <div class="flex flex-col justify-end">
        <h1 class="text-lg font-bold text-right">Partenaires</h1>
        @if ($errors->any())
            ...
            <div class="flex items-center justify-center gap-3 by-5">
                <div class="flex flex-1 gap-5 py-5">
                    <div class="flex flex-col flex-1 gap-3">
                        <input type="text" class="flex-1 w-full p-2 placeholder-gray-700 border-2 rounded-lg" placeholder="Nom" id="lib" wire:model="lib">
                ...
                <div class="grid grid-cols-2 gap-4 bg-white">
                    ...
                    <button class="text-lg font-bold text-white bg-gray-500 -3" wire:click="resetFields" @click="descri='';lib='';id=0">Clear</button>        
                </div>
            </div>
