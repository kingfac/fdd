<div x-data="{
    ...
    <div class="px-5 py-5 ">
        <div class="flex flex-col gap-4 divide-y-2">
            <div class="p-2">   
                <h1 class="text-xl font-bold text-right divide-x-4 divide-gray-300">RESEAUX SOCIAUX</h1>
                <div class="flex flex-col py-5">
                    <div class="flex flex-1 gap-5 py-5">
                        <div class="flex flex-col flex-1 gap-3">
                            <input name="" id="" wire:model="lib" class="flex-1 w-full p-2 placeholder-gray-600 transition transform border rounded-lg" placeholder="Nom du compte" />
                            <input name="" id="" wire:model="lien" class="flex-1 w-full p-2 placeholder-gray-600 transition transform border rounded-lg" placeholder="Lien" />
