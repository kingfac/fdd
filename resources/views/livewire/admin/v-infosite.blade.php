<div x-data="{
    ...
    <div class="flex px-5 py-5">
        <div class="flex flex-col flex-1 gap-4 px-5 divide-y-2">
            <div class="p-2">   
                <h1 class="text-xl font-bold text-right divide-x-4 divide-gray-300">Informations du site</h1>
                <div class="flex flex-col py-5">
                    <div class="flex flex-col flex-1 gap-5 py-5">
                        <input type="text" class="flex-1 p-2 placeholder-gray-700 border-2 rounded-lg" placeholder="LIBELLE" id="titre" wire:model="titre">
                        <textarea name="h" id="descri" wire:model="descri" class="flex-1 p-2 placeholder-gray-600 transition transform border rounded-lg" placeholder="Description"></textarea>
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <button class="flex-1 text-lg font-bold text-white bg-gray-500 -3" wire:click="resetFields" @click="descri='';titre='';id=0">Clear</button>        
                    </div>
        ...
        <div class="flex flex-col py-2">
            <div class="flex flex-col px-10 shadow-xl">
                <h1 class="pb-10 text-lg font-bold text-center">MISE A JOUR CEO PROFIL</h1>
                <div class="flex flex-col py-5" 
                ...
                >
                    <div class="flex flex-col gap-4 p-2 border">
                        @if (Storage::exists('public/profil/ceo.png'))    
                        <img src="{{asset('storage/profil/ceo.png')}}?{{ rand() }}" alt="Pas d'image pour cette info" srcset="" class="flex-1">
                        @endif
                        ...
                        <button class="flex-1 px-3 py-2 text-lg font-bold text-white bg-blue-900 hover:bg-blue-700" wire:click="profil">Enregistrer Profil</button>
                    </div>
                    @if ($photo)
                    <div class="flex flex-col justify-center p-2 text-center shadow">
