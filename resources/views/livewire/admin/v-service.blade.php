<div x-data="{
    ...
    <div class="px-5 py-5">
        <div class="flex flex-col gap-4 divide-y-2">
            <div class="p-2">   
                <h1 class="text-xl font-bold text-right divide-x-4 divide-gray-300">Services</h1>
                <div class="flex flex-col py-5">
                    <div class="flex flex-col flex-1 gap-5 py-5">
                        <input type="text" class="flex-1 p-2 placeholder-gray-700 border-2 rounded-lg" placeholder="Nom / Titre" id="lib" wire:model="lib">
